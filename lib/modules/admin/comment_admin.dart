...
class CommentAdminPage extends StatelessWidget {

  String postId;
  String collection;
  CommentAdminPage(this.postId,this.collection) ;

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context)=>AdminLayoutCubit(),
      child: BlocConsumer<AdminLayoutCubit,AdminStates>(
        listener: (context,state){},
        builder: (context,state){
          AdminLayoutCubit.get(context).getComments(postId,collection);
          List<CommentModel> model=AdminLayoutCubit.get(context).getcomment;
          return Scaffold(
            body:
